  ...
  return (
    ...
    >
      <SwiperSlide className="relative cursor-pointer !h-[260px] ml:!h-[230px] ml:!w-[420px] s:!h-[230px] s:!w-[420px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2 s:rounded-2xl">
          <div>
            ...
            <p className="s:line-clamp-3 xs:text-xs">다양성이 더 생기면 좋겠어요.</p>
          </div>
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] ml:!h-[230px] ml:!w-[420px] s:!h-[230px] s:!w-[420px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2 s:rounded-2xl">
          <div>
            <strong className="text-lg font-semibold mb-2 s:line-clamp-1 xs:text-sm">식단 추천 너무 좋아요.</strong>
            <p className="s:line-clamp-3 xs:text-xs">
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] ml:!h-[230px] ml:!w-[420px] s:!h-[230px] s:!w-[420px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2 s:rounded-2xl">
          <div>
            ...
            <p className="s:line-clamp-3 xs:text-xs">저칼로리인데 생각보다 맛있어요!!</p>
          </div>
          <div className="text-gray300 xs:text-xs">
            <span>20대 여성</span>
            <p>건강 감량 목표</p>
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] ml:!h-[230px] ml:!w-[420px] s:!h-[230px] s:!w-[420px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2 s:rounded-2xl">
          <div>
            <strong className="text-lg font-semibold mb-2 s:line-clamp-1 xs:text-sm">두부 파스타를 만들었어요</strong>
            <p className="s:line-clamp-3 xs:text-xs">
