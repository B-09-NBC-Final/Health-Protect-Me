  ...
  return (
    ...
    >
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2">
          <div>
            ...
            <p className="s:line-clamp-3 s:text-xs">간식까지 추천해줘서 좋아요!! 식사 보충 겸 간식까지~</p>
          </div>
          <div className="text-gray300 s:text-xs">
            <span>20대 여성</span>
            <p>건강 식사 목표</p>
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2">
          <div>
            <strong className="text-lg font-semibold mb-2 s:line-clamp-1 s:text-sm">다이어트 식단으로 효과적</strong>
            <p className="s:line-clamp-3 s:text-xs">
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2">
          <div>
            <strong className="text-lg font-semibold mb-2 s:line-clamp-1 s:text-sm">식단 추천에 운동까지.</strong>
            <p className="s:line-clamp-3 s:text-xs">
