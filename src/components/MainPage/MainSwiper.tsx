  ...
  return (
    ...
    >
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2">
          <div>
            ...
            <p className="s:line-clamp-3">간식까지 추천해줘서 좋아요!! 식사 보충 겸 간식까지~</p>
          </div>
          <div>
            <span>20대 여성</span>
            <p>건강 식사 목표</p>
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2">
          <div>
            ...
            <p className="s:line-clamp-3">체중 감량으로 선택하니 적당히 포만감도 있는데 다이어트에 효과적이에요..!</p>
          </div>
          <div>
            <span>20대 남성</span>
            <p>체중 감량 목표</p>
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2">
          <div>
            <strong className="text-lg font-semibold mb-2">헬프미를 사용한 이후로 체중 관리가 잘 돼요.</strong>
            <p className="s:line-clamp-3">
      ...
      <SwiperSlide className="relative cursor-pointer !h-[260px] xs:!h-[146px] xs:!w-[270px]">
        ...
        <div className="text-area xs:!p-4 xs:!pb-2">
          <div>
            <strong className="text-lg font-semibold mb-2">식단 추천에 운동까지.</strong>
            <p className="s:line-clamp-3">
